            ...
            children: [
              ...
              Container(
                ...
                child: StaggeredGridView.countBuilder(
                  ...
                  {
                    CategoryList c = cl[index];
                    return GestureDetector(
                      onTap: ()
                      {

                        Navigator.push(context, MaterialPageRoute(builder: (context)=> ShowFlorists()));
                      },
                      child: Stack(
                        children: [
                         ...
                         ClipRRect(
                              ...
                              child: Image.asset(
                                c.photoUrl,
                                fit: BoxFit.cover,
                                color: Color(0xff333333).withOpacity(0.48),
                          ...
                          Positioned(
                            ...
                            child:
                            Container(
                              constraints: BoxConstraints(maxWidth: _screenSize.width / 1.4,),
                              child: Text(
                                c.categoryName,
                                textAlign: TextAlign.left,
                                overflow: TextOverflow.ellipsis,
